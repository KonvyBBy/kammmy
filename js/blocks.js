...
const BLOCK_FACES = {
  ...
  [BlockType.DIRT]:          [TILE.DIRT]*6,
  [BlockType.STONE]:         [TILE.STONE]*6,
  [BlockType.COBBLESTONE]:   [TILE.COBBLE]*6,
  [BlockType.SAND]:          [TILE.SAND]*6,
  [BlockType.GRAVEL]:        [TILE.GRAVEL]*6,
  ...
  [BlockType.OAK_PLANKS]:    [TILE.OAK_PLANKS]*6,
  [BlockType.OAK_LEAVES]:    [TILE.OAK_LEAVES]*6,
  [BlockType.GLASS]:         [TILE.GLASS]*6,
  [BlockType.WATER]:         [TILE.WATER]*6,
  [BlockType.LAVA]:          [TILE.LAVA]*6,
  [BlockType.SNOW_BLOCK]:    [TILE.SNOW]*6,
  [BlockType.ICE]:           [TILE.ICE]*6,
  [BlockType.BEDROCK]:       [TILE.BEDROCK]*6,
  [BlockType.COAL_ORE]:      [TILE.COAL_ORE]*6,
  [BlockType.IRON_ORE]:      [TILE.IRON_ORE]*6,
  [BlockType.GOLD_ORE]:      [TILE.GOLD_ORE]*6,
  [BlockType.DIAMOND_ORE]:   [TILE.DIAMOND_ORE]*6,
  [BlockType.BRICK]:         [TILE.BRICK]*6,
  [BlockType.OBSIDIAN]:      [TILE.OBSIDIAN]*6,
  [BlockType.GLOWSTONE]:     [TILE.GLOWSTONE]*6,
  ...
  [BlockType.SPRUCE_LEAVES]: [TILE.SPRUCE_LEAVES]*6,
  [BlockType.SPRUCE_PLANKS]: [TILE.SPRUCE_PLANKS]*6,
  [BlockType.CACTUS]:        [TILE.CACTUS_SIDE, TILE.CACTUS_SIDE, TILE.CACTUS_TOP, TILE.CACTUS_TOP, TILE.CACTUS_SIDE, TILE.CACTUS_SIDE],
  [BlockType.MOSSY_COBBLE]:  [TILE.MOSSY_COBBLE]*6,
  ...
  [BlockType.WOOL_WHITE]:    [TILE.WOOL_WHITE]*6,
  [BlockType.WOOL_RED]:      [TILE.WOOL_RED]*6,
  [BlockType.WOOL_BLUE]:     [TILE.WOOL_BLUE]*6,
  [BlockType.WOOL_GREEN]:    [TILE.WOOL_GREEN]*6,
  ...
  [BlockType.EMERALD_ORE]:   [TILE.EMERALD_ORE]*6,
  [BlockType.REDSTONE_ORE]:  [TILE.REDSTONE_ORE]*6,
  [BlockType.NETHERRACK]:    [TILE.NETHERRACK]*6,
  [BlockType.SOUL_SAND]:     [TILE.SOUL_SAND]*6,
};
